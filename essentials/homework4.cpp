...
int main(int argc, const char * argv[]){
    ...
    //real cache spaces
    int cache_valid[sets][associative]={0};
    int cache_tag[sets][associative]={0};
    int cache_LRU[sets][associative]={0};
    int cache_FIFO[sets]={0};
    ...
    for(int i=0;i<num_of_address;i++)
    {
        ...
        //special implementatiom trasnfer hex string to integer value
        stringstream ss;
        unsigned int binval;
        ss<<hex<<address[i];
        ss>>binval;
